...
CREATE TABLE IF NOT EXISTS Quit_Plan (
    ...
    starting_date DATE,
    end_date DATE,
    target_timeline_months INT DEFAULT 1,
    starting_nicotine_mg DECIMAL(10,2) DEFAULT 0,
    daily_nicotine_allowance_mg DECIMAL(10,2) DEFAULT 0,
    selected_brand_id INT,
    selected_brand_type ENUM('Cigarette', 'Vape') DEFAULT 'Cigarette',
    alert BOOLEAN,
